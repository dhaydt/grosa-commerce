<div class="row mb-4" style="max-height: 400px">
    <div class="banner col-md-3">
        <a href="/" class="h-100">
            <div class="bandiv" style="min-height: 400px; width: 96%; background-color: {{ $web_config['primary_color'] }};border-radius:10px">
                <img style="max-height: 400px; min-height: 400px;"  src="{{asset("storage/app/public/company")."/".$web_config['flash_banner']->value}}" alt="">
            </div>
        </a>
    </div>
    <div class="col-md-10 d-flex align-items-center" style="margin-left: -105px">
        <div class="owl-carousel owl-theme mt-2" id="flash-deal-slider">
            ...
            <div class="flash_deal_product rtl" style="cursor: pointer; min-height: 335px; border-radius: 10px; overflow:hidden"
